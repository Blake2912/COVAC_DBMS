...
<head>
    ...
    <title>Other Registrations</title>
</head>
<body>
<br>
    <div class="container">
    ...
    <div class="container">
        <div class="card">
            ...
            <div class="container">
                ...
                <button type="button" class="btn btn-info">Register Hospital</button>
            </div>
            <br>
        </div>
        <br>
        <div class="card">
            <br>
                <div class="container">
                    ...
                    <button type="button" class="btn btn-warning">Register Vaccinator</button>
                </div>
            <br>
        </div>
        <br>
    ...
    <div class="contaner">
        <div class="container">
            <button type="button" class="btn btn-outline-dark" id="go_to_reg">Go to user registrations</button>
        </div>
    </div>
</body>
</html>
...
<script type="text/javascript">
    ...
    document.getElementById("go_to_reg").onclick = function () {
        location.href = "http://10.211.55.2/COVAC/COVAC_DBMS/Pages/covac_register.php";
    };
